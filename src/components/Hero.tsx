    ...
    <section className="min-h-screen flex items-center justify-center pt-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            Young Developer building impactful digital systems.
          </motion.h2>
          ...
          >
            Specialized in React, JavaScript, Node.js, and MongoDB. Passionate
            about creating automation systems, billing platforms, AI
            integration, and modern UI/UX experiences.
          </motion.p>
