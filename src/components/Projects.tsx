  ...
  const projects = [
    {
      ...
      description:
        "An intelligent AI-powered system for financial education and personal money management. Features budgeting recommendations, statistical simulations, and comprehensive economic education tools.",
      tech: ["React", "Node.js", "MongoDB", "AI Integration"],
      features: [
        "Smart budgeting recommendations",
        "Statistical simulations",
        "Economic education modules",
      ],
      demoUrl: "#",
      githubUrl: "#",
    },
    {
      ...
      description:
        "Complete web dashboard for managing Wi-Fi customers with automated invoice generation and WhatsApp integration for seamless customer communication.",
    ...
    },
    {
      ...
      description:
        "Real-world automation system for sending invoices to customers automatically via WhatsApp. Implements admin number routing for production-ready deployment.",
      tech: ["Node.js", "WhatsApp API", "Automation"],
      features: [
        "Automated customer notifications",
        "Admin number implementation",
    ...
    },
    {
      ...
      description:
        "Collection of UI experiments and mini applications including todo lists, calculators, and interactive components showcasing modern design patterns.",
