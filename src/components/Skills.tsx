...
const Skills = () => {
    ...
    const skillCategories = [
        ...
        },
        {
            ...
            skills: ["API Integration", "WhatsApp Automation", "Invoice Systems", "UI/UX Design", "AI Integration"]
        }
    ];

    return (
        <section id="skills" ref={ref} className="py-20 sm:py-32 px-4 sm:px-6 lg:px-8 bg-secondary/30">
            <div className="container mx-auto">
                ...
                >
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Tech Stack Yang Saya Gunakan</p>
                </motion.div>
